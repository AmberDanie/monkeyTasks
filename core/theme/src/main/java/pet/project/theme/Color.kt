...
val LightYellow = Color(0xFFFFC300)
...
val lightThemeColorList = listOf(
    SupportLightSeparator, SupportLightOverlay, LabelLightPrimary,
    LabelLightSecondary, LabelLightTertiary, LabelLightDisable, LightRed, LightGreen, LightYellow,
...
val DarkYellow = Color(0xFFC7B40F)
...
val darkThemeColorList = listOf(
    ...
    LabelDarkSecondary, LabelDarkTertiary, LabelDarkDisable, DarkRed, DarkGreen, DarkYellow,
